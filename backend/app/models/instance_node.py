...
from app.models.enums import InstanceNodeStatus, ApprovalStrategy
...
class InstanceNode(Base):
    ...
    file_folders: Mapped[list[dict] | None] = mapped_column(JSON, nullable=True, comment="文件提交文件夹配置快照")
    ...
    status: Mapped[str] = mapped_column(String(20), default=InstanceNodeStatus.WAITING.value, comment="节点状态")
