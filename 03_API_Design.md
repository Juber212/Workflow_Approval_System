# 智展研究院设计开发管理系统 — API 接口设计

> **版本**：3.2 | **状态**：与代码同步 | **更新**：2026-08-10
>
> 92 HTTP 端点 + 1 WebSocket。完整定义见 FastAPI Swagger `/docs`。
...
> 注：本清单部分新端点可能滞后于实现（如 dashboard 趋势图、方案、通知补充等），以实际代码为准，完整定义见 Swagger `/docs`。
