  ...
  <div class="check-detail" v-loading="loading">
    ...
    <template v-if="detail">
      <div class="info-card">
        ...
        <div class="info-grid">
          <div><span class="k">提交人</span><span class="v">{{ detail.checker_name ? '校验人' : '' }}{{ detail.instance_name }}</span></div>
          <div><span class="k">状态</span><span class="v">{{ detail.status }}</span></div>
        </div>
      </div>
...
.check-detail { max-width: 900px; margin: 0 auto; }
