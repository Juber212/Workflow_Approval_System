<template>
  ...
  <div class="org-proposal-home">
    ...
    <!-- 发起方案弹窗（预先填充当前组织） -->
    <el-dialog v-model="showCreateDialog" title="发起方案" width="520px" :close-on-click-modal="false" @closed="resetForm">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="110px">
        <el-form-item label="设计联络单" prop="name">
          <el-input v-model="form.name" placeholder="输入设计联络单" maxlength="100" />
        </el-form-item>
...
const rules: FormRules = {
  name: [{ required: true, message: '请输入设计联络单', trigger: 'blur' }],
